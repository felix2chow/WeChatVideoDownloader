1、不要从视频号进去，从电脑版微信侧边栏的“搜一搜”那里进去，然后输入你要下载的视频标题，点击搜索，出来的结果里再选“视频号”，软件里跳出的链接就可以预览了，下载完是可以播放的。

2、亲测，通过搜一搜预览的视频链接是可以抓取的，不过用fiddler这些抓包软件都可以直接抓取到
  不用打开视频详情页的，，就在搜索结果的列表页，视频会自动播放，这个时候抓取到的视频就是未加密的，视频地址是：https://findermp.video.qq.com 开头的

3、去掉&token=前面的一些参数就是清晰视频
